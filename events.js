...
function addPlayerToTeam(playerList, i)//Realistically, you pass a letter then use that as the player object(name, position, salary, vorp)
{
  ...
  case "SS":
    ...
    //teamList.SalaryTotal += playerList[i].Salary;
    teamList.ShortStop += playerList[i].Vorp;
    break;
  case "LF":
...
//teamList.VorpTotal = teamList.LeftFieldVorp + teamList.CenterFieldVorp + teamList.RightFieldVorp + teamList.ShortStopVorp+ teamList.ThirdBaseVorp + teamList.SecondBaseVorp + teamList.FirstBaseVorp + teamList.PitcherVorp + teamList.CatcherVorp;
